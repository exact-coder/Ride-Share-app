import { View, Text, KeyboardAvoidingView, TouchableWithoutFeedback, TextInput, Image, Platform, Keyboard } from 'react-native'
import React from 'react'
import { InputFieldProps } from '@/types/type';

const InputField = ({ label, labelStyle, icon, iconStyle,inputStyle, secureTextEntry = false, containerStyle, className, ...props }: InputFieldProps) => {
  return (
